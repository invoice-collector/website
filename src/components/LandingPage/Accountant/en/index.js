                    ...
                    <div className="max-w-5xl mx-auto px-6 py-20">
                        ...
                        <div className="grid lg:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-sm">
                                ...
                                <div className="mb-5">
                                    <div className="flex justify-between text-sm mb-1"><span className="text-gray-600">Active clients (N)</span><span className="font-semibold text-primary" id="vN">200</span></div>
                                    <input type="range" min="20" max="1000" defaultValue="200" id="sN" className="w-full" />
                                </div>
                                <div className="mb-5">
                                    <div className="flex justify-between text-sm mb-1"><span className="text-gray-600">Portal invoices / client / month</span><span className="font-semibold text-primary" id="vX">4</span></div>
                                    <input type="range" min="1" max="15" defaultValue="4" id="sX" className="w-full" />
                                </div>
                                <div className="mb-5">
                                    <div className="flex justify-between text-sm mb-1"><span className="text-gray-600">Minutes saved / invoice</span><span className="font-semibold text-primary" id="vT">3 min</span></div>
                                    <input type="range" min="2" max="8" defaultValue="3" id="sT" className="w-full" />
                                </div>
                                <div className="mb-6">
                                    <div className="flex justify-between text-sm mb-1"><span className="text-gray-600">Staff hourly cost</span><span className="font-semibold text-primary" id="vH">35€</span></div>
                                ...
                                <div className="bg-primary-light rounded-xl p-6 text-center mb-4">
                                    ...
                                    <div className="text-xs text-primary mt-2" id="rR">i.e. × 10.9 the €129 plan</div>
                                </div>
                                <div className="text-sm text-gray-500 text-center mb-5">Break-even: <strong id="rBE">74 invoices/month</strong> — i.e. <strong id="rC">~19 clients</strong> to cover the subscription</div>
