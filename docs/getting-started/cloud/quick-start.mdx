...
<div style={{ textAlign: 'center' }}>
  <Button label="Request a new bearer token" link="https://registry.invoice-collector.com/v1/bearer" />
</div>
<br/>
...
Wondering what the UX looks like?
  <Button label="Try the DEMO" link="https://registry.invoice-collector.com/v1/demo" />
</div>
