...
If you do not want to wait, you can directly ask the server to send a fake invoice to your callback from the [Settings page](https://app.invoice-collector.com/settings) or with the following request:
```bash
