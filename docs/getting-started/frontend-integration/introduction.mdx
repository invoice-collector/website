...
<Tabs>
  <TabItem value="iframe" label="iFrame Integration" default>
    Ready to get started quickly? Follow our [iFrame Integration Guide](./iframe-integration) to embed Invoice-Collector in minutes.
  </TabItem>
  <TabItem value="api" label="Full API Integration">
    Need full control? Check out our [Full API Integration Guide](./api-integration) for complete implementation details.
  </TabItem>
</Tabs>
