...
<Tabs groupId="server-base-url">
  ...
  <TabItem value="self-hosted" label="Self-Hosted">
    ...
    You can update it your `callback` url with a POST request to the [`POST /customer`](../api.mdx#tag/Customer/paths/~1customer/post) endpoint.
  </TabItem>
</Tabs>
...
You can make a POST request to the `POST /user` endpoint to create it in our database and generate the token.
