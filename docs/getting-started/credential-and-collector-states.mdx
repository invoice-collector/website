...
| `credential.collector.state != "planned" and (credential.state.index == 1 or credential.state.index == 2 or credential.state.index == 4)` | In progress | Authentication or 2FA verification is in progress |
